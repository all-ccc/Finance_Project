...
def get_deposit_products():
	...
	for dic in option_result:
		option_list = {}
		option_list['금융상품코드'] = dic['fin_prdt_cd']
		option_list['저축 금리'] = dic['intr_rate']
		option_list['저축 기간'] = dic['save_trm']
		option_list['저축금리유형'] = dic['intr_rate_type']
		option_list['저축금리유형명'] = dic['intr_rate_type_nm']
		option_list['최고 우대금리'] = dic['intr_rate2']
